...
class User(BaseModel, db.Model):
    ...
    def to_dict(self):
        resp_dict = {
            ...
            self.name,
            "avatar_url":
            constants.QINIU_DOMIN_PREFIX + self.avatar_url
...
class House(BaseModel, db.Model):
    ...
    user_id = db.Column(
        db.Integer, db.ForeignKey("ih_user_profile.id"),
        nullable=False)  # 房屋主人的用户编号
    area_id = db.Column(
        db.Integer, db.ForeignKey("ih_area_info.id"),
    ...
    def to_simple_dict(self):
        return {
            ...
            self.title,
            "img_url":
            constants.QINIU_DOMIN_PREFIX + self.index_image_url
            if self.index_image_url else "",
        }
    ...
    def to_basic_dict(self):
        ...
        house_dict = {
            ...
            self.address,
            "user_avatar":
            constants.QINIU_DOMIN_PREFIX + self.user.avatar_url
            if self.user.avatar_url else "",
            "ctime":
...
class HouseImage(BaseModel, db.Model):
    ...
    house_id = db.Column(
        db.Integer, db.ForeignKey("ih_house_info.id"), nullable=False)  # 房屋编号
...
class Order(BaseModel, db.Model):
    ...
    house_id = db.Column(
        db.Integer, db.ForeignKey("ih_house_info.id"),
    ...
    def to_dict(self):
        ...
        order_dict = {
            ...
            self.house.title,
            "img_url":
            constants.QINIU_DOMIN_PREFIX + self.house.index_image_url
            if self.house.index_image_url else "",
            "start_date":
